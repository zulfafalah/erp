...
import { PurchaseInvoiceListItem, TabKey } from "./types";
...
export const tabs: { key: TabKey; label: string; icon: string; badge?: string }[] = [
    ...
    { key: "invoice-details", label: "Detail Invoice", icon: "receipt" },
    { key: "attachments",     label: "Lampiran",       icon: "attachment" },
];

// ─── Item Table Columns (for detail page) ─────────────────────────────────────

export const purchaseInvoiceColumns: ColumnDef<ProductItem>[] = [
...
export const FILTER_FIELDS: FilterField[] = [
    { key: "search",          label: "Cari (No./Pemasok)",   type: "text" },
    { key: "rcvno",           label: "No. PIV",               type: "text" },
    ...
    { key: "rcvdate__gte", label: "Tgl. Invoice Mulai", type: "text" },
    { key: "rcvdate__lte", label: "Tgl. Invoice Akhir", type: "text" },
];
...
): Column<PurchaseInvoiceListItem>[] => [
    {
        key: "rcvno",
        header: "No. PIV",
        render: (item) => (
            <Link
                href={`/purchase/invoice/${item.rcvid}`}
