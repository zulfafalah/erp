...
import { GoodsReceivingListItem } from "../../api/purchase/receipts/route";
import {
    FILTER_FIELDS,
    DIRECT_PARAM_FIELDS,
    buildColumns,
...
export default function PurchaseReceiptListPage() {
    const [data,        setData]        = useState<GoodsReceivingListItem[]>([]);
    ...
    const fetchData = useCallback(async (
        ...
        try {
            ...
            const paginated = json.data as { count: number; results: GoodsReceivingListItem[] };
    ...
    const handleDelete = async (rcvid: number) => {
        setIsDeleting(true);
        try {
            const res = await fetch(`/api/purchase/receipts/${rcvid}`, { method: "DELETE" });
            if (res.ok) {
                setDeletingId(null);
                ...
                <section className="flex-1 flex flex-col bg-background-light overflow-hidden">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 md:p-8 pb-28 md:pb-8 space-y-4 md:space-y-8">
                        ...
                        <DataTable
                            ...
                            isLoading={loading}
                            emptyIcon="inbox"
                            emptyText="Tidak ada data. Coba ubah filter atau tambah penerimaan baru."
                            renderMobileCard={(item) =>
                                ReceiptMobileCard(item, setDeletingId)
                            }
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-4">
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <p className="font-bold text-slate-900">Hapus Penerimaan Barang?</p>
