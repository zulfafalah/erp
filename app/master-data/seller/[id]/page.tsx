                ...
                <section className="flex-1 flex flex-col bg-background-light overflow-hidden">
                    ...
                    <div className="px-4 md:px-6 py-3 md:py-4 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-primary/5 bg-white/50 backdrop-blur-sm shrink-0">
                        <div className="flex items-start md:items-center gap-3 md:gap-4 w-full md:w-auto">
                            <button
                                onClick={() => router.push("/master-data/seller")}
                            ...
                            <div>
                                ...
                                <p className="text-[10px] md:text-xs text-slate-500 font-medium mt-1">
                                    Kelola master data penjual di sistem.
                                </p>
                            </div>
                        </div>
                                ...
                                <div className="lg:col-span-2 space-y-6">
                                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                                        ...
                                        <div className="px-4 md:px-6 py-3 md:py-4 border-b border-slate-100 flex items-center gap-2">
                                            ...
                                            <h3 className="font-bold text-slate-800">Informasi Penjual</h3>
                                        </div>
                                        ...
                                        <div className="p-4 md:p-6 space-y-4 md:space-y-5">
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-4 gap-2 items-center">
                                                ...
                                                <div className="sm:col-span-3 w-2/3">
                                                    <FormInput
                                                        ...
                                                        defaultValue="via.chjp@gmail.com"
                                                        type="email"
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            {/* Aktif */}
                                            <div className="grid grid-cols-1 sm:grid-cols-4 gap-2 items-center">
                                                <label className="text-sm font-medium text-red-500 sm:col-span-1">
                                                    Aktif ?
                                                </label>
                                                <div className="sm:col-span-3">
                                                    <input
                                                        type="checkbox"
                                                        defaultChecked
                                                        className="w-4 h-4 rounded border-slate-300 text-primary accent-blue-600 cursor-pointer"
                                                    />
                                                </div>
                                            </div>
                                    ...
                                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden sticky top-0">
                                        ...
                                        <div className="p-4 md:p-6 space-y-3">
                                            <p className="text-xs text-slate-500 leading-relaxed">
                                                Data penjual digunakan sebagai referensi dalam transaksi penjualan dan komisi penjualan.
                                            </p>
