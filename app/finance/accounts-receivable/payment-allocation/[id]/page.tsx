...
interface PaymentAllocationARDetail {
    noTransaksi: string;
    tanggal: string;
    pelanggan: string;
    mataUang: string;
...
const mockData: Record<string, PaymentAllocationARDetail> = {
    "ARS2604-0001": {
        ...
        catatan: "",
        status: "Approved",
        jumlahOriginal: 327971.70,
        jumlahLokal: 327971.70,
        details: [
            {
                id: "D001",
                noBilyet: "BGI 2604-0001",
                nilaiSisaBilyet: 672028.30,
                notaNo: "SIL 2601-0001, 2026-01-06 ~ 0.00",
                keterangan: "SIL 2601-0001, 2026-01-06",
                tglBayar: "2026-04-10",
                mataUang: "RP",
                kursBayar: 1.00,
                totalBayar: 327971.70,
            },
        ],
    },
    "ARS2309-0001": {
    ...
    "ARS2107-0001": {
        ...
        catatan: "",
        status: "Approved",
        jumlahOriginal: 15000000.01,
        jumlahLokal: 15000000.01,
        details: [],
    },
    new: {
        noTransaksi: "[Auto]",
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <FormField label="No. Bilyet">
                            <div className="flex gap-2">
                                <FormSelect>
                                    <option value="BGI2604-0001">BGI 2604-0001 ~ Transfer</option>
                                    <option value="BGI2309-0001">BGI 2309-0001 ~ Transfer</option>
                                    <option value="BGI2107-0001">BGI 2107-0001 ~ Cheque</option>
                                </FormSelect>
                                <FormInput
                                    defaultValue="672,028.30"
                                    readOnly
                        ...
                        <FormField label="Nota #">
                            <FormSelect>
                                <option value="SIL2601-0001">SIL 2601-0001, 2026-01-06 ~ 0.00</option>
                                <option value="SIL2512-0001">SIL 2512-0001, 2025-12-31 ~ 0.00</option>
                            </FormSelect>
                        </FormField>

                        <FormField label="Keterangan">
                            <FormInput defaultValue="SIL 2601-0001, 2026-01-06" />
                        </FormField>
                        ...
                        <FormField label="Total Bayar">
                            <div className="flex items-center gap-3">
                                <FormInput type="number" defaultValue="327971.70" className="flex-1" />
...
export default function PaymentAllocationARDetailPage({
    params,
}: {
                ...
                <section className="flex-1 flex flex-col bg-background-light overflow-hidden">
                    ...
                    <div className="px-4 md:px-6 py-3 md:py-4 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-primary/5 bg-white/50 backdrop-blur-sm shrink-0">
                        ...
                        <div className="flex items-start md:items-center gap-3 md:gap-4 w-full md:w-auto">
                            <button
                                onClick={() => router.push("/finance/accounts-receivable/payment-allocation")}
                            ...
                            <div>
                                <div className="flex flex-wrap items-center gap-2">
                                    <h1 className="text-lg md:text-xl font-bold text-slate-900 leading-tight">
                                        {isNew ? "Tambah Alokasi Penerimaan" : data.noTransaksi}
                                    </h1>
                                ...
                                <p className="text-[10px] md:text-xs text-slate-500 font-medium mt-1">
                                    Input Alokasi Penerimaan Pembayaran Dari Pelanggan
                                </p>
                            </div>
                        </div>
                                            ...
                                            <div className="p-4 md:p-6 grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                                                ...
                                                <FormField label="Pelanggan" className="sm:col-span-2">
                                                    <FormSelect defaultValue={data.pelanggan}>
                                                        ...
                                                        <option value="BERSATU INDAH GEMILANG,CV">BERSATU INDAH GEMILANG,CV</option>
