...
const allData: SalesCommission[] = [
    {
        id: "PKP26040001",
        noTransaksi: "PKP26040001",
        tanggal: "2026-04-06 00:00:00",
        penjual: "APHAN",
        jumlah: 0.00,
        status: "Draft",
    ...
    {
        id: "PKP26010002",
        noTransaksi: "PKP26010002",
        tanggal: "2026-01-31 00:00:00",
        penjual: "APHAN",
        jumlah: 2100000.00,
        status: "Closed",
        keterangan: "Komisi untuk : JANUARI (2)",
    },
    {
        id: "PKP26010001",
        ...
        jumlah: 980000.00,
        status: "Closed",
        keterangan: "Komisi untuk : JANUARI",
    },
];
...
const FILTER_FIELDS: FilterField[] = [
    { key: "noTransaksi", label: "Transaksi #",  type: "text" },
...
export default function SalesCommissionsListPage() {
    const [filteredData, setFilteredData] = useState<SalesCommission[]>(allData);
    ...
    const columns: Column<SalesCommission>[] = [
        ...
        },
        {
            ...
            render: (r) => (
                <Link
                    href={`/finance/sales-commissions/${r.id}`}
        ...
        },
        {
            ...
            key: "keterangan",
            render: (r) => (
                <span className="text-sm text-slate-600 max-w-[240px] truncate block" title={r.keterangan}>
                    {r.keterangan}
                </span>
            ),
        },
    ...
    const renderMobileCard = (r: SalesCommission) => (
        <div className="p-4 space-y-3">
            ...
            <div>
                ...
                <p className="text-xs text-slate-500 truncate">{r.keterangan}</p>
            </div>
            <div className="flex justify-between items-center pt-2 border-t border-slate-100">
                <div>
                    <p className="text-[11px] text-slate-400">Jumlah</p>
                    <span className="text-sm font-bold text-primary">{fmtCur(r.jumlah)}</span>
                </div>
                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                            <div>
                                ...
                                <p className="text-slate-500 mt-1">
                                    Pencatatan dan pengelolaan pembayaran komisi penjualan untuk penjual.
                                </p>
                            </div>
                            <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 md:gap-3 w-full md:w-auto mt-2 md:mt-0">
                                <MultiFilter fields={FILTER_FIELDS} onApplyFilter={handleApplyFilter} />
                                <Link
                                    href="/finance/sales-commissions/new"
