...
function ReportContent() {
    ...
    const reportType = searchParams.get("report") || "purchase-invoice-detail";

    // Configuration for different report types
    const reportConfigs: Record<string, any> = {
        "purchase-invoice-detail": {
            title: "Laporan Detil Nota Pembelian Barang",
            desc: "Filter dan tampilkan laporan detail pembelian (PIV) berdasarkan periode, pemasok, produk, dan outlet.",
            type: "detail",
            columns: [
        ...
        "purchase-invoice-summary": {
            title: "Laporan Rekapitulasi Nota Pembelian Barang",
            desc: "Filter dan tampilkan rekapitulasi nota pembelian (PIV) berdasarkan periode, pemasok, dan outlet.",
            type: "summary",
            columns: [
                { key: "noNota", label: "No. Nota", align: "left" },
                { key: "tanggal", label: "Tanggal", align: "left" },
                ...
                { key: "totalHarga", label: "Total Pembelian", align: "right", render: (r: any) => formatCurrency(r.totalHarga) },
                { key: "status", label: "Status", align: "center" },
            ],
            data: [
                { noNota: "PIV2401-0002", tanggal: "2026-04-02", pemasok: "TRIAL", outlet: "GKPK", totalItem: 5, totalHarga: 410000, status: "Approved" },
                { noNota: "PIV2401-0001", tanggal: "2026-04-14", pemasok: "CHUP", outlet: "GKPK", totalItem: 3, totalHarga: 31157547, status: "Approved" },
            ],
        ...
        "default": {
            ...
            desc: "Laporan data pembelian barang",
            type: "summary",
            columns: [
                { key: "noNota", label: "No. Nota", align: "left" },
                { key: "tanggal", label: "Tanggal", align: "left" },
            ...
            data: [
                { noNota: "POB2401-0001", tanggal: "2026-04-10", pemasok: "TRIAL", totalHarga: 500000 }
            ],
            grandTotalKey: "totalHarga"
        }
    };
    ...
    if (!reportConfigs[reportType] && reportType.includes("detail")) {
        config.title = "Laporan Detil " + reportType.replace(/-/g, " ");
        config.type = "detail";
    }
