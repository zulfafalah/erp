...
export default function StatusBar() {
    ...
    return (
        <>
            ...
            {/* Mobile Info Popup */}
            {showMobileInfo && (
                <div className="fixed bottom-10 left-3 z-[60] bg-slate-800 border border-slate-700 p-3 rounded-md shadow-lg flex flex-col gap-2 md:hidden min-w-[200px] animate-in slide-in-from-bottom-2 fade-in duration-200 text-[10px] uppercase font-bold tracking-widest text-slate-400">
