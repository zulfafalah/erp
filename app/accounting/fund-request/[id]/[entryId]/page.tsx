...
const tabs: { key: TabKey; label: string; icon: string }[] = [
    { key: "header", label: "Input Detail Pencatatan Permintaan Dana", icon: "edit_note" },
];

// ─── Mock No. Bukti Options ───────────────────────────────────────────────────

const noBuktiOptions = [
    { value: "",                label: ":: Pilih No Bukti ::"       },
    { value: "BKK-2020-04-001", label: "BKK-2020-04-001"            },
    { value: "BKK-2020-04-002", label: "BKK-2020-04-002"            },
    { value: "BKK-2020-04-003", label: "BKK-2020-04-003"            },
    { value: "BKK-2020-04-004", label: "BKK-2020-04-004"            },
    { value: "BKK-2020-04-005", label: "BKK-2020-04-005"            },
    { value: "BKK-2020-04-006", label: "BKK-2020-04-006"            },
    { value: "BKK-2020-03-020", label: "BKK-2020-03-020"            },
    { value: "BKK-2020-03-019", label: "BKK-2020-03-019"            },
];

// ─── Page ─────────────────────────────────────────────────────────────────────

export default function FundRequestEntryPage() {
                ...
                <section className="flex-1 flex flex-col bg-background-light overflow-hidden">
                    ...
                    <div className="px-4 md:px-6 py-3 md:py-4 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-primary/5 bg-white/50 backdrop-blur-sm shrink-0">
                        <div className="flex items-start md:items-center gap-3 md:gap-4 w-full md:w-auto">
                            <button
                                onClick={() => router.push("/accounting/fund-request/1")}
                            ...
                            <div>
                                <div className="flex flex-wrap items-center gap-2">
                                    <h1 className="text-lg md:text-xl font-bold text-slate-900 leading-tight">
                                        :: Input Detail Pencatatan Permintaan Dana PKK20030009
                                    </h1>
                                </div>
                                <p className="text-[10px] md:text-xs text-slate-500 font-medium mt-1">
                                    Pilih No. Bukti untuk mengisi detail permintaan dana ini.
                                </p>
                            </div>
                        </div>
                                    ...
                                    <div className="lg:col-span-2 space-y-6">
                                        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                                            ...
                                            <div className="px-4 md:px-6 py-3 md:py-4 border-b border-slate-100 flex items-center gap-2">
                                                ...
                                                <h3 className="font-bold text-slate-800">Input Detail Permintaan Dana</h3>
                                            </div>
                                            {/* Card Body */}
                                        ...
                                        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden sticky top-0">
                                            ...
                                            <div className="p-4 md:p-6 space-y-3">
                                                <p className="text-xs text-slate-500 leading-relaxed">
                                                    Pilih nomor bukti yang sesuai untuk mengisi detail pencatatan permintaan dana. Setiap bukti hanya dapat digunakan sekali per pengajuan.
                                                </p>
                                                <div className="pt-3 border-t border-slate-100 space-y-2">
                                                    {[
                                                        { label: "No. Pengajuan", value: "PKK20030009"             },
                                                        { label: "Kode Akun",     value: "110.01.01 - KAS KECIL"   },
                                                        { label: "No. Bukti",     value: noBukti || "(belum dipilih)" },
                                                    ].map((row) => (
