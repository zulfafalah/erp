...
const tabs: { key: TabKey; label: string; icon: string }[] = [
    { key: "header", label: "Input Detil Jurnal Umum", icon: "edit_note" },
];
...
const kodeAkunOptions = [
    ...
    { value: "120.02.03", label: "120.02.03 - OCBC 2388-0000-5879 (IDR)" },
    { value: "130.01.01", label: "130.01.01 - PIUTANG DAGANG" },
    { value: "170.02.02", label: "170.02.02 - AKUM PENY. KENDARAAN" },
    { value: "210.01.01", label: "210.01.01 - HUTANG DAGANG PEMB. LOKAL" },
    { value: "210.04.01", label: "210.04.01 - HUTANG POTONGAN CLAIM" },
    ...
    { value: "550.00.21", label: "550.00.21 - BIAYA PENGOBATAN KARYAWAN" },
    { value: "550.00.25", label: "550.00.25 - BIAYA SELISIH BAYAR PEMBELIAN & PENJUALAN" },
...
export default function GeneralJournalEntryPage() {
    ...
    // Form state
    const [kodeAkun,    setKodeAkun]    = useState("110.01.02");
    const [keterangan,  setKeterangan]  = useState("test");
    const [voucherNo,   setVoucherNo]   = useState("1");
    const [dc,          setDc]          = useState<"Debet" | "Kredit">("Debet");
    const [jumlah,      setJumlah]      = useState("0.00");
    const [jumlahOrig,  setJumlahOrig]  = useState("0.00");
                ...
                <section className="flex-1 flex flex-col bg-background-light overflow-hidden">
                    ...
                    <div className="px-4 md:px-6 py-3 md:py-4 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-primary/5 bg-white/50 backdrop-blur-sm shrink-0">
                        <div className="flex items-start md:items-center gap-3 md:gap-4 w-full md:w-auto">
                            <button
                                onClick={() => router.push("/accounting/general-journal/1")}
                            ...
                            <div>
                                <div className="flex flex-wrap items-center gap-2">
                                    <h1 className="text-lg md:text-xl font-bold text-slate-900 leading-tight">
                                        :: Input Detil Jurnal Umum BKM26040001
                                    </h1>
                                </div>
                                <p className="text-[10px] md:text-xs text-slate-500 font-medium mt-1">
                                    Tambah atau edit entri detail untuk jurnal ini.
                                </p>
                            </div>
                        </div>
                                        ...
                                        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden sticky top-0">
                                            ...
                                            <div className="p-4 md:p-6 space-y-3">
                                                <p className="text-xs text-slate-500 leading-relaxed">
                                                    Jurnal umum digunakan untuk mencatat semua transaksi keuangan yang tidak masuk ke jurnal khusus. Pastikan saldo debet dan kredit selalu seimbang.
                                                </p>
                                                <div className="pt-3 border-t border-slate-100 space-y-2">
                                                    {[
                                                        { label: "Journal No",    value: "BKM26040001" },
                                                        { label: "Kode Transaksi",value: "Bukti Kas Masuk (BKM)" },
                                                        { label: "Tanggal",       value: "2026-04-11" },
