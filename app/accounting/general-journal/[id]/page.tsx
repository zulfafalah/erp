...
const journalHeader: JurnalHeader = {
    ...
    status:            "Open",
    totalDebetLocal:   0,
    totalDebetOriginal: 0,
    totalKreditLocal:  0,
    totalKreditOriginal: 0,
    totalKonversi:     0,
};
...
const allDetails: JurnalDetail[] = [
    {
        id: "1",
        akunPerkiraan: "110.01.02 - KAS KECIL MEDAN",
        keterangan:    "test",
        voucherNo:     "1",
        dc:            "Debet",
        jumlahDebet:   0.001,
...
export default function GeneralJournalDetailPage() {
    ...
    const detailColumns: Column<JurnalDetail>[] = [
        ...
        },
        {
            ...
            render: (item) => (
                <Link
                    href={`/accounting/general-journal/1/${item.id}`}
                                    ...
                                    <div className="lg:col-span-2 space-y-6">
                                        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                                            ...
                                            <div className="px-4 md:px-6 py-3 md:py-4 border-b border-slate-100 flex items-center gap-2">
                                                ...
                                                <h3 className="font-bold text-slate-800">Informasi Jurnal</h3>
                                            </div>
                                            {/* Card Body */}
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-4 gap-2 items-center">
                                                    ...
                                                    <div className="sm:col-span-3">
                                                        <FormSelect
                                                            ...
                                                            className="w-64"
                                                        >
                                                            <option value="BKM">Bukti Kas Masuk (BKM)</option>
                                                            <option value="BKK">Bukti Kas Keluar (BKK)</option>
                                                            <option value="JU">Jurnal Umum (JU)</option>
                                                            <option value="JP">Jurnal Penyesuaian (JP)</option>
                                                            <option value="JR">Jurnal Retur (JR)</option>
                                                        </FormSelect>
                                                    </div>
                                                </div>
                                    ...
                                    <div className="space-y-6">
                                        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden sticky top-0">
                                            ...
                                            <div className="p-4 bg-slate-50 border-t border-slate-100 grid grid-cols-2 gap-2">
                                                ...
                                                <button className="py-2 bg-emerald-500 text-white rounded text-xs font-bold hover:bg-emerald-600 transition-colors flex items-center justify-center gap-1">
                                                    <span className="material-symbols-outlined !text-sm">verified</span> POST
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="flex-1 flex flex-col overflow-hidden">
                                ...
                                <div className="flex flex-wrap items-center justify-between gap-3 mb-4 shrink-0">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Link
                                            href="/accounting/general-journal/1/new"
