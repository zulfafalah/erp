...
const tabs: { key: TabKey; label: string; icon: string }[] = [
    { key: "header", label: "Data Saldo Awal Akun Perkiraan Tahunan", icon: "account_balance" },
];
...
export default function YearlyOpeningBalanceEntryPage() {
                ...
                <section className="flex-1 flex flex-col bg-background-light overflow-hidden">
                    ...
                    <div className="px-4 md:px-6 py-3 md:py-4 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-primary/5 bg-white/50 backdrop-blur-sm shrink-0">
                        <div className="flex items-start md:items-center gap-3 md:gap-4 w-full md:w-auto">
                            <button
                                onClick={() => router.push("/accounting/yearly-opening-balance/1")}
                            ...
                            <div>
                                <div className="flex flex-wrap items-center gap-2">
                                    <h1 className="text-lg md:text-xl font-bold text-slate-900 leading-tight">
                                        :: Data Saldo Awal Akun Perkiraan Tahunan
                                    </h1>
                                </div>
                                        ...
                                        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                                            ...
                                            <div className="p-4 md:p-6 space-y-4">
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-4 gap-2 items-center">
                                                    ...
                                                    <div className="sm:col-span-3">
                                                        <FormSelect className="w-full max-w-lg" defaultValue="170.02.02">
                                        ...
                                        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden sticky top-0">
                                            ...
                                            <div className="p-4 md:p-6 space-y-3">
                                                <p className="text-xs text-slate-500 leading-relaxed">
                                                    Saldo awal akun perkiraan tahunan digunakan sebagai saldo pembuka untuk setiap periode akuntansi perusahaan.
                                                </p>
                                                <div className="pt-3 border-t border-slate-100 space-y-2">
                                                    <div className="flex justify-between items-center text-xs">
                                                        <span className="text-slate-500">Periode</span>
                                                        <span className="font-mono font-semibold text-slate-700">202000</span>
                                                    </div>
                                                    <div className="flex justify-between items-center text-xs">
                                                        <span className="text-slate-500">Tanggal</span>
                                                        <span className="font-semibold text-slate-700">2020-01-01</span>
                                                    </div>
                                                    <div className="flex justify-between items-center text-xs">
