...
type TransferStatus = "Draft" | "In Transit" | "Approved";
...
const tabs: { key: TabKey; label: string; icon: string }[] = [
    ...
    { key: "item-details", label: "Detail Pengiriman",     icon: "local_shipping" },
...
export default function StockTransferOutboundDetailPage() {
    ...
    return (
        <div className="bg-background-light text-slate-900 font-sans min-h-screen flex flex-col overflow-hidden pb-8">
                ...
                <section className="flex-1 flex flex-col bg-background-light overflow-hidden">
                    ...
                    <div className="px-4 md:px-6 py-3 md:py-4 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-primary/5 bg-white/50 backdrop-blur-sm shrink-0">
                        <div className="flex items-start md:items-center gap-3 md:gap-4 w-full md:w-auto">
                            <button
                                onClick={() => router.push("/inventory/stock-transfer-outbound")}
                            ...
                            <div>
                                <div className="flex flex-wrap items-center gap-2">
                                    <h1 className="text-lg md:text-xl font-bold text-slate-900 leading-tight">
                                        Perpindahan Barang Antar Gudang (Kirim)
                                    </h1>
                                ...
                                <p className="text-[10px] md:text-xs text-slate-500 font-medium mt-1">
                                    Input dan kelola pengiriman perpindahan barang antar gudang (outbound).
                                </p>
                            </div>
                        </div>
                                    ...
                                    <div className="lg:col-span-2 space-y-6">
                                        ...
                                        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                                            ...
                                            <div className="p-4 md:p-6 grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                                                <FormField label="No.">
                                                    <FormInput defaultValue="SOU 2206-0001" />
                                                </FormField>
                                                <FormField label="Tanggal">
                                                    <FormInput type="date" defaultValue="2022-06-30" />
                                                </FormField>
                                                <FormField label="Status">
                                                    <FormInput defaultValue="In Transit" readOnly />
                                                </FormField>
                                                ...
                                                <FormField label="Catatan Tambahan" className="sm:col-span-2">
                                                    <FormTextarea
                                                        placeholder="Tambahkan catatan untuk perpindahan ini..."
                                                        rows={3}
                                                        defaultValue="Perpindahan Stok karena BOOKING CUSTOMER"
                                                    />
                                                </FormField>
                                            </div>
                                        </div>
                                    ...
                                    <div className="space-y-6">
                                        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden sticky top-0">
                                            <div className="px-4 md:px-6 py-3 md:py-4 border-b border-slate-100 flex items-center gap-2">
                                                ...
                                                <h3 className="font-bold text-slate-800">Ringkasan Transfer</h3>
                                            </div>
                                    ...
                                    <div className="px-4 py-3 border-b border-slate-100 flex items-center justify-between shrink-0">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <h3 className="text-sm font-bold text-slate-900">
                                                Daftar Detail Pengiriman Barang
            ...
            <Modal
                ...
                title="Input Detil Perpindahan Barang Antar Gudang (Kirim)"
                icon="move_to_inbox"
                size="xl"
                footer={
                    <>
            ...
            >
                ...
                <FormField label="Qty Transfer">
                    <FormInput
                        type="number"
                        value={String(newItem.qtyKirim)}
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateNew({ qtyKirim: Number(e.target.value) })}
                    />
                </FormField>

                {/* Qty Terima (read-only) */}
                <FormField label="Qty Terima">
                    <input
                        type="number"
                        readOnly
                        className="w-full rounded-lg border border-slate-200 bg-primary/5 px-3 py-2 text-sm text-right font-bold cursor-default outline-none text-primary"
                        value={fmt2(newItem.qtyTerima)}
                    />
                </FormField>
            </Modal>
            ...
            {selectedItem && (
                <Modal
                    ...
                    title={`Input Detil Perpindahan Barang Antar Gudang (Kirim)->${selectedItem.namaBarang}`}
                    icon="edit_square"
                    size="xl"
                    footer={
                        <>
                ...
                >
                    ...
                    <FormField label="Qty Transfer">
                        <FormInput
                            type="number"
                            value={String(selectedItem.qtyKirim)}
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateSelectedItem({ qtyKirim: Number(e.target.value) })}
                        />
                    </FormField>
                    ...
                    <FormField label="Qty Terima">
                        <input
                            ...
                            readOnly
                            className="w-full rounded-lg border border-slate-200 bg-primary/5 px-3 py-2 text-sm text-right font-bold cursor-default outline-none text-primary"
                            value={fmt2(selectedItem.qtyTerima)}
                        />
                    </FormField>
                </Modal>
            )}
