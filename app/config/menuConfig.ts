    ...
    },
    {
        ...
        sidebarSections: [
            ...
            },
            {
                title: "Akuntansi",
                items: [
                    { label: "Buku Besar", icon: "menu_book", href: "/reports/accounting?report=general-ledger" },
                    { label: "Jurnal Harian", icon: "today", href: "/reports/accounting?report=daily-journal" },
                    { label: "Jurnal Umum", icon: "auto_stories", href: "/reports/accounting?report=general-journal" },
                    { label: "Daftar Akun", icon: "account_tree", href: "/reports/accounting?report=chart-of-accounts" },
                    { label: "Laba Rugi Perpetual", icon: "trending_up", href: "/reports/accounting?report=perpetual-income-statement" },
                    { label: "Laba Rugi Harian", icon: "show_chart", href: "/reports/accounting?report=daily-income-statement" },
                    { label: "Neraca", icon: "balance", href: "/reports/accounting?report=balance-sheet" },
                    { label: "Neraca Saldo Bulanan", icon: "calendar_month", href: "/reports/accounting?report=monthly-trial-balance" },
                    { label: "Neraca Saldo 3 Bulan", icon: "date_range", href: "/reports/accounting?report=quarterly-trial-balance" },
                ],
            },
            {
                title: "Utilitas",
